odoo.define('thiqah_portal.request_portal_sidebar', function (require) {
'use strict';
...
publicWidget.registry.ServiceRequestSideBar = PortalSidebar.extend({
    selector : '.o_portal_service_request_sidebar',
    events: {
        'click .o_portal_service_request_print' : '_onPrintServiceRequest'
    },
    ...
    start: function () {
        ...
        var $invoiceHtml = this.$el.find('iframe#service_request_html');
     ...
     * @param {MouseEvent} ev
     */
    _onPrintServiceRequest : function(ev){
        ev.preventDefault();
